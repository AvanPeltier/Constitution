...
\asubsection{Responsibilities of the Public Relations Director}
\begin{enumerate}
	\item To preside over Public Relations Meetings in which House members are encouraged to bring ideas for public outreach events
	\item To exercise general supervision over Public Relations operations
	\item To oversee the organization, initiation, and execution of House outreach activities and events
	\item To ensure that there is an overall positive public image of CSH across campus and in the area
\end{enumerate}
...
\asubsection{Prospective Evaluations}
At the beginning of each semester, the Evaluations Director, Socials Director(s), and Public relations Director will host a series of publically broadcasted events to allow potential introductory members to meet and socialize with Active Members, Alumni, and Introductory Members accepted over the summer.
There will be a minimum of four events, with two additionally dedicated times to interview prospective members.
...
The Process will occur once per semester and will last for six (6 ) school weeks.
The Process shall be initiated by the Evaluations Director after the second week of each semester at the conclusion of (\ref{Prospective Evaluations}).
...
Each Introductory Process participant, after the start of the introductory process, is given a document that is used to keep track of progress when interacting with upperclassmen throughout the entirety of the process using their signatures. 
Intro-members can collect signatures from All Active Members and any of the following non-student members: 
\begin{itemize}
	\item Alumni members
...
\asubsubsubsection{Introductory Member Meeting}
Each Introductory Process participant, after the start of the introductory process, is expected to attend weekly informational meetings. 
Failure to attend these meetings can lead to removal from the introductory process at the discretion of the Evaluations director and a majority vote of the Executive board. 
The purpose of these meetings is to generate an understanding of the function and purpose of CSH. 
These meetings will run for at least an hour in length. 
The Evaluations director is expected to have formulated a set curriculum complete with special presenters for each of the weeks leading up to the final Introductory Evaluation. 
It is expected that the second half of this meeting's time will be used for team-building / bonding between the introductory members.
One of these meetings will be a mandatory House Meeting sit-in for introductory members.
Attendance of at least one of these meetings is mandatory for all Active Members
...
\begin{itemize}
\item Attend all Introductory Member meetings as defined by (\ref {Introductory Member Meeting}) during the process
\item Have signatures on the Introductory Packet
...
\begin{enumerate}
	\item The applicant attends interest events and meets current members.
...
\end{enumerate}
Note: Membership privileges do not initiate until successful completion of the introductory process.
...
\begin{enumerate}
	...
	\item A subset of applications will be selected to move onto the House Fall Semester, are granted full membership privileges (including On-Floor status), and must participate in the Introductory Process as defined in \ref{The Introductory Process}.
		...
		An additional subset will be rejected and encouraged to attend prospective evaluations in the Fall
\end{enumerate}
Note: Membership privileges do not initiate until successful completion of the introductory process.
This means that until the member has passed the Introductory Evaluation, the member does NOT have the right to vote on House issues and does NOT count towards quorum.
The member does, however, have the right to use Computer Science House's facilities.
...
Before active, or alumni members may receive an account they must:
\renewcommand{\theenumi}{\alph{enumi}} % For this section, we want items to use letters
\begin{enumerate}
	...
	\item Successfully complete Introductory Evaluations.
\end{enumerate}
